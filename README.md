...
- 编辑模式下支持修改卡片显示名称。
- 编辑模式下支持拖动卡片调整展示顺序。
- 编辑模式下支持删除卡片，删除前会弹出确认提示。
- 编辑模式下支持拖动同一卡片内的收藏网页调整顺序。
- 编辑模式下支持为收藏网页添加别名和用途标签。
- 编辑模式下支持删除收藏网页，删除前会弹出确认提示。
...
- 编辑模式下，拖动卡片可调整页面展示顺序。
- 编辑模式下，点击卡片右上角 `删除卡片` 会删除真实浏览器收藏夹及其内部收藏。
- 编辑模式下，拖动收藏网页到同一卡片内另一行的上半部 / 下半部，可调整收藏顺序。
- 编辑模式下，点击收藏行右侧 `编辑` 可添加别名和用途标签。
- 编辑模式下，点击收藏行右侧 `删除` 可删除真实浏览器收藏，删除前会确认。
